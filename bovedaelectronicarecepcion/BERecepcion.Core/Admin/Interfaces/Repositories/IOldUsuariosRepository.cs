...
{
    public interface IOldUsuariosRepository
    {
        ...
        Task<DataResult<UsuarioActualizaResponseDto>> ActualizaBloqueaAsync(string UserNameModifier, Guid userId);

        Task<DataResult<UsuarioActualizaResponseDto>> ActualizaAdministracionAsync(string UserName, Guid userId);

        Task<DataResult<UsuarioActualizaResponseDto>> ActualizaAdministracionNaAsync(string UserName, Guid userId);

        Task<DataResult<UsuarioActualizaResponseDto>> ActualizaAdminAsync(string UserName, Guid userId);
        ...
        Task<DataResult<IEnumerable<UsuariosSearchResponseDto>>> GetUsuarioSearchAsync(string Text);
