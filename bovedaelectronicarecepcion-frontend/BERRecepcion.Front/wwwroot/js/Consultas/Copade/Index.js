$(document).ready(function () {
    setOpenMenu("menu_Consulta", "StatisticsCopade");
...
var ConsultaCopadeTable = function (fechaInicial, fechaFinal, search = [], pageNum = 1) {
    $.ajax({
        type: "POST",
        url: "Consultas/ConsultaCopadeTable",
...
$("#btnExcel").on("click", function (e) {
    ...
    location.href = "Consultas/DownloadExcelCopade?fechaInicial=" + fechaInicial + "&fechaFinal=" + fechaFinal + "&search=" + search;
    e.stopImmediatePropagation();
});
